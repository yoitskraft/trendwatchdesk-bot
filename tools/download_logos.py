#!/usr/bin/env python3
import os, io, sys, time, json, shutil, textwrap
...
# If you have GOOG.png but not GOOGL.png we’ll mirror it.
MIRRORS = {
    "GOOGL": "GOOG",
}

# 🔗 Curated domains (edit/add freely). ETFs point to issuer domains.
TICKER_DOMAIN: Dict[str, str] = {
    # Big Tech / MAG7
    "AAPL":"apple.com","MSFT":"microsoft.com","GOOGL":"google.com","GOOG":"google.com",
    "META":"about.facebook.com","AMZN":"amazon.com","NVDA":"nvidia.com","TSLA":"tesla.com","NFLX":"netflix.com",
    ...
    # Cloud / SaaS / Data
    "CRM":"salesforce.com","NOW":"servicenow.com","SNOW":"snowflake.com","DDOG":"datadoghq.com",
    "MDB":"mongodb.com","PLTR":"palantir.com",
...
# Full WATCHLIST from latest main.py (edit if you trimmed it)
WATCHLIST = [
...
def ticker_badge(tkr: str, w=512, h=256) -> Image.Image:
    ...
    # soft rounded rect with faint border
